...
// }
function redBalloon() {
  var red = createSprite(0,Math.round(random(10, 400)), 10, 9);
  red.addImage(red_balloonImage);
  red.velocityX = 3;
  red.lifetime = 150;
  red.scale = 0.1;
...
function blueBalloon() {
  var blue = createSprite(0,Math.round(random(50, 10)), 8, 1);
...
function greenBalloon() {
  var green = createSprite(0,Math.round(random(40, 250)), 6, 7);
...
function pinkBalloon() {
  var pink = createSprite(0,Math.round(random(20, 370)), 3, 5);
